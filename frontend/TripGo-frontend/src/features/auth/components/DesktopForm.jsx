            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input className={inputCls(errors.email)} placeholder="Enter your mail" type="email" autoComplete="off" value={formData.email} onChange={set('email')} />
                </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <input className={inputCls(errors.phone)} placeholder="Enter the phone number" type="tel" value={formData.phone} onChange={set('phone')} />
                  </div>
