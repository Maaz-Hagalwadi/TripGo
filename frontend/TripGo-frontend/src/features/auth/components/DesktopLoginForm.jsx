  ...
  return (
    <div className="theme-bg theme-text min-h-screen flex">
      ...
      <div className="w-full flex flex-row min-h-screen">
        ...
        <div className="w-full md:w-1/2 p-6 md:p-16 flex flex-col justify-center theme-bg/60">
          <div className="max-w-md w-full mx-auto">
            ...
            <div className="mt-10">
              ...
              <button 
                ...
                className="w-full flex items-center justify-center gap-3 py-3 px-4 bg-white/5 hover:bg-white/10 border border-white/5 rounded-xl transition-all font-semibold"
              >
